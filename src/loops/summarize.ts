...
import type { TextBackend, TextSpec, Written } from "../llm/backend.ts";
...
export function summarize(paper: Paper, config: FinderConfig, backend: TextBackend): Promise<Written<Summary>> {
